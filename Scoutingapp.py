...
if menu == "Lista corta":
    ...
    if df_short.empty:
        ...
        # =========================================================
        # ⚽ CANCHA CON INTERACCIÓN + FICHA LATERAL
        # =========================================================
        with tabs[1]:
            ...
            with col1:
                st.markdown("#### 🔍 Buscar jugador para ver ficha")
                ...
                if not df_filtrado.empty:
                    ...
                    if seleccion:
                        ...
                        if not jugador_data.empty:
                            ...
                            st.warning("⚠️ No se encontró información del jugador.")
                    else:
